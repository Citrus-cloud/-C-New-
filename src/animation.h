...
// Класс общий: используется для игрока, врагов, боссов и эффектов.
// =====================================================================
class Animation
{
public:
    ...
    // scale — масштаб, flipX — отражение по горизонтали, tint — подсветка.
    ...
    // Размер одного кадра в пикселях (для вычисления масштаба).
